...
class _MovieDetailPageState extends State<MovieDetailPage> {
    ...
    Future.microtask(
      () {
        ...
        context
            ...
            .add(OnLoadWatchlistMovieStatus(widget.id));
      },
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocConsumer<MovieDetailBloc, MovieDetailData>(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              onPressed: () {
                                if (!isAddedWatchlist) {
                                  context
                                      .read<MovieDetailBloc>()
                                      .add(OnAddToWatchlistMovie(movie));
                                } else {
                                  context
                                      .read<MovieDetailBloc>()
                                      .add(OnRemoveFromWatchlistMovie(movie));
                                }
                              },
                              child: Row(
                            ...
                            BlocBuilder<MovieDetailBloc, MovieDetailData>(
                              builder: (context, state) {
